...
.. autofunction:: run_simul
   :noindex:

   This function orchestrates the execution of the simulation. It takes a field and a list of cars as input, displays the initial state of the cars, and iteratively executes their commands until all cars have collided or all commands are completed.

Module Usage
------------

This module provides a framework for simulating car movements. Users can use the `run_simul` function to execute the simulation by providing a field object, a an array containing cars.
